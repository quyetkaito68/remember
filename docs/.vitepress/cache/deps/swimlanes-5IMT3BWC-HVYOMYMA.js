...
async function createGraphWithElements(element, data4Layout) {
  ...
  if (globalThis.mermaidCaptureSizes) {
    const { captureNodeSizes } = await import("./sizeCapture-X5ZJPWSS-DS4ISCBT.js");
...
//# sourceMappingURL=swimlanes-5IMT3BWC-HVYOMYMA.js.map
