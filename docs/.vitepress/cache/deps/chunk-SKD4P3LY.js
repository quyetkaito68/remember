import {
  ...
  markers_default,
  positionEdgeLabel
} from "./chunk-YDFEHXFB.js";
import {
  insertCluster,
  insertNode,
  labelHelper
} from "./chunk-43PVFTVG.js";
import {
  interpolateToCurve
...
var registerDefaultLayoutLoaders = __name(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: __name(async () => await import("./dagre-VKFMJZFB-VLJG5X6E.js"), "loader")
    },
    {
      name: "swimlane",
      loader: __name(async () => await import("./swimlanes-5IMT3BWC-HVYOMYMA.js"), "loader")
    },
    ...true ? [
      {
        name: "cose-bilkent",
        loader: __name(async () => await import("./cose-bilkent-JH36ORCC-YOEH7EXZ.js"), "loader")
      }
    ] : []
  ]);
...
//# sourceMappingURL=chunk-SKD4P3LY.js.map
